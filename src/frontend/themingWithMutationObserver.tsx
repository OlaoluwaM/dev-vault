// import PropTypes from 'prop-types'; // NOTE: Needs to be installed in project
// import designTokens from '../configs/design-tokens.json'; // NOTE: design tokens to be available in some way in project

// import { isOptional } from '../types'; // NOTE: Can be gotten from ./utility-types dir in dev-vault
// import { ThemeProvider } from 'styled-components'; // NOTE: Needs to be installed in project
// import { useEffect, useState } from 'react'; // NOTE: Needs to be installed in project
// import { includedInCollection, objSet } from '../utils'; // NOTE: Can be gotten from ./utility-types dir in dev-vault
// import { LS_THEME_KEY, THEME_ATTRIBUTE } from '../constants'; // NOTE: Needs to be created in project
...
export default function GlobalThemeProvider({
  ...
  const [selectedTheme, setSelectedTheme] =
    useState<ThemeVariant>(getDefaultTheme);
...
function getDefaultTheme(): ThemeVariant {
  ...
  if (!lastChosenThemeVariant)
    lastChosenThemeVariant = getUserThemePreference();
...
function isThemeVariantSting(str: string): str is ThemeVariant {
